...
const STORAGE_KEY = 'escritor_48h_state_v6';
...
function updateTutorialUI() {
    ...
    if (target) {
        ...
        if (step.pos === 'bottom') {
            ...
            card.style.top = (rect.top + scrollY - 220) + 'px';
            card.style.left = (rect.left + rect.width/2 - 140) + 'px';
...
function downloadFile(content, fileName, contentType) {
    ...
    reader.onload = function(e) {
        ...
        // Método robusto para WebView: mudar o window.location para o data URI
        // O DownloadListener no Kotlin vai interceptar isso
